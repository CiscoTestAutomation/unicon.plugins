...
Uses the unicon_plugins.tests.mock.mock_device_ios script to test NXOS plugin.
...
from unicon.core.errors import SubCommandFailure, StateMachineError, \
    ConnectionError
from unicon_plugins.tests.mock.mock_device_nxos import MockDeviceTcpWrapperNXOS
