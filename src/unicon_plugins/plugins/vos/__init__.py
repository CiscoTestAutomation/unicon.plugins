...
from unicon_plugins.plugins.generic import GenericSingleRpConnection, service_implementation as svc
from unicon_plugins.plugins.generic.connection_provider import GenericSingleRpConnectionProvider

from unicon_plugins.plugins.generic import ServiceList, service_implementation as svc
