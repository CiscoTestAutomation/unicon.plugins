...
from unicon_plugins.plugins.aireos.settings import AireosSettings
from unicon_plugins.plugins.aireos.statemachine import AireosStateMachine
from unicon_plugins.plugins.generic import ServiceList
from unicon_plugins.plugins.aireos import service_implementation as svc

from .patterns import AireosPatterns

from unicon_plugins.plugins.utils import (get_current_credential,
