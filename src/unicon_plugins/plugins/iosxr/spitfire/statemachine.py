...
from unicon_plugins.plugins.iosxr.spitfire.patterns import SpitfirePatterns 
from unicon_plugins.plugins.iosxr.spitfire.statements import SpitfireStatements
