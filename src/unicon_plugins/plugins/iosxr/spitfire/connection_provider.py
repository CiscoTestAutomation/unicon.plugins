...
from unicon_plugins.plugins.iosxr.connection_provider import IOSXRSingleRpConnectionProvider,IOSXRDualRpConnectionProvider
from unicon.eal.dialogs import Dialog
from unicon_plugins.plugins.iosxr.spitfire.statements import connection_statement_list
