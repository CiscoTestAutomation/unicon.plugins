...
from unicon.plugins.generic.service_statements import (
    save_env, confirm_reset, reload_confirm, reload_confirm_ios, useracess,
    confirm_config, setup_dialog, auto_install_dialog, module_reload,
    save_module_cfg, reboot_confirm, secure_passwd_std, admin_password,
    auto_provision, login_stmt, send_response, password_handler)
from unicon.plugins.iosxr.service_statements import confirm_module_reload_stmt

from .service_patterns import IOSXRSpitfireReloadPatterns

pat = IOSXRSpitfireReloadPatterns()
