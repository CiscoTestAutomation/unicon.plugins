...
class MockDeviceGeneric(MockDevice):

    def __init__(self, *args, **kwargs):
        super().__init__(*args, device_os='generic', **kwargs)


class MockDeviceTcpWrapperGeneric(MockDeviceTcpWrapper):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.mockdevice = MockDeviceGeneric(*args, **kwargs)
...
def main(args=None):
    ...
    md = MockDeviceGeneric(hostname=hostname, state=state)
    md.run()
