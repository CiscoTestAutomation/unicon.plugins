...
timos_statements = TimosStatements()
timos_pre_connection_statement_list = pre_connection_statement_list
timos_auth_other_statement_list = [timos_statements.permission_denied_stmt]
timos_auth_username_password_statement_list = [timos_statements.username_stmt,
