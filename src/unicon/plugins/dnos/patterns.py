...
class DnosPatterns(UniconCorePatterns):
    ...
    def __init__(self):
        ...
        self.commit_changes_prompt = r'^Warning: Configuration includes uncommitted changes, would you like to commit them before exiting \(yes/no/cancel\) \[cancel\]?'
